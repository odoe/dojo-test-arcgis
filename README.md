...
Dojo cli currently does not work with the ArcGIS API for JavaScript. It looks like the webpack config of the build tools is stricter than most in terms of circular dependencies and will error on build. Once the module is published, we can work toward finding how to fix this.
